module.exports = app => {
	...
	app.post("/api/transport/:planId/:newPlanId", transport.duplicate);
	...
	// app.get("/api/transport/find/plan/:planId/:dayIndex/:transOrder",transport.findInPlan);
	// app.put("/api/transport/:sourceId/:destinationId", transport.updateOne);
	app.put("/api/transport/:planId/:day/:order", transport.updateOne);
	app.delete("/api/transport/delete/:planId", transport.deletePlanIdAll);
	app.delete("/api/transport/delete/:planId/:day/:order", transport.deletePlanIdOne);
